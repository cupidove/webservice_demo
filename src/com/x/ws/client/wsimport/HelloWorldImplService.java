 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://rpcstyle.ws.x.com/", wsdlLocation = "http://localhost:9999/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://rpcstyle.ws.x.com/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://rpcstyle.ws.x.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://rpcstyle.ws.x.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
