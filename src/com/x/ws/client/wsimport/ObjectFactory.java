 ...
 * generated in the com.x.ws.client.wsimport package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://rpcstyle.ws.x.com/", "getHelloWorldAsString");
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://rpcstyle.ws.x.com/", "getHelloWorldAsStringResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.x.ws.client.wsimport
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rpcstyle.ws.x.com/", name = "getHelloWorldAsString")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rpcstyle.ws.x.com/", name = "getHelloWorldAsStringResponse")
